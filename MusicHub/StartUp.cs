    ...
    public class StartUp
    {
        ...
        private static void ImportEntities(MusicHubDbContext context, string baseDir, string exportDir)
        {
            var writers = DataProcessor.Deserializer.ImportWriters(context,
                    File.ReadAllText(@"E:\Кодене\DB Adv Exam Retake 04 2019\MusicHub\Datasets\ImportWriters.json"));
            ...
            var producerAlbums = DataProcessor.Deserializer.ImportProducersAlbums(context,
                    File.ReadAllText(@"E:\Кодене\DB Adv Exam Retake 04 2019\MusicHub\Datasets\ImportProducersAlbums.json"));
            ...
            var songs = DataProcessor.Deserializer.ImportSongs(context, 
                File.ReadAllText(@"E:\Кодене\DB Adv Exam Retake 04 2019\MusicHub\Datasets\ImportSongs.xml"));
            ...
            var performers = DataProcessor.Deserializer.ImportSongPerformers(context, 
                File.ReadAllText(@"E:\Кодене\DB Adv Exam Retake 04 2019\MusicHub\Datasets\ImportSongPerformers.xml"));
